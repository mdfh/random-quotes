...
import com.assignment.quote.connectivity.base.ConnectivityProvider.NetworkState.ConnectedState.ConnectedLegacy
...
/**
 * As getActiveNetworkInfo() was deprecated for higher API levels, here we are providing support
 * for the older devices which uses activeNetworkInfo
 *
 * Created by Faraz on 26/06/20.
 */

@Suppress("DEPRECATION")
class AppConnectivityProviderLegacy(
